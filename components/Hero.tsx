...
const Hero = () => {
  return (
    <div className="pb-20 pt-40" id='home'>
        <div>
            <Spotlight className="-top40 -left-10 md:-left-32 md:-top-20 h-screen" fill="white" />
            <Spotlight className="-top10 -left-full h-[80vh] w-[50vw]" fill="white" />
            <Spotlight className="-top28 -left-80 h-[80vh] w-[50vw]" fill="white" />
        </div>
    ...
    <div className="flex justify-center relative my-20 z-10">
      <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
        ...
        <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
          Hello, I am Vinivesh, a web developer and an aspiring data analyst from India 
        </p>
